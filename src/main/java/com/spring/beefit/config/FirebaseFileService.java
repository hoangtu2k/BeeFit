package com.spring.beefit.config;
...
public class FirebaseFileService {
    ...
    public void init(ApplicationReadyEvent event) {
        try {
            ...
            storage = StorageOptions.newBuilder()
                    ...
                    .setProjectId("beefit-e0b4c").build().getService();
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
    ...
    public String saveTest(MultipartFile file) throws IOException {
        ...
        BlobId blobId = BlobId.of("beefit-e0b4c.appspot.com", imageName);
        ...
        url.append("https://firebasestorage.googleapis.com/v0/b/beefit-e0b4c.appspot.com/o/");
    ...
    public String deleteFile(String url) {
        try {
            String fileName =
                    url.replace("https://firebasestorage.googleapis.com/v0/b/beefit-e0b4c.appspot.com/o/", "").replace("?alt=media", "");
            ClassPathResource serviceAccount = new ClassPathResource("firebase-service-account-key.json");
            String projectId = "beefit-e0b4c";
            Storage storage = StorageOptions.newBuilder()
                    .setProjectId(projectId)
                    .setCredentials(GoogleCredentials.fromStream(serviceAccount.getInputStream()))
                    .build()
                    .getService();
            String bucketName = "beefit-e0b4c.appspot.com";
